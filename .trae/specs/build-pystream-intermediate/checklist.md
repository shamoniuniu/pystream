...
- [x] 每个里程碑有独立 commit、远端分支和 `git revert` 记录
- [x] `main` 未被中级开发直接修改
- [x] 开发日志、运行日志、验收报告齐全且不含敏感信息
...
- [x] 二级 count distribution demo 结果正确
...
- [x] 分支覆盖率 >= 80%
- [x] 初级 WordCount Docker E2E 通过
- [x] 中级 event-time/retract Docker E2E 通过
- [x] Worker 故障恢复 Docker E2E 通过
- [x] 验收清理后无项目资源残留

## 声明边界

- [x] 文档明确停流 Checkpoint 的暂停成本
- [x] 文档明确共享卷和单 JobManager 故障域
- [x] 文档明确追加 File Sink 可能重复
- [x] 文档未宣称 Exactly-once
