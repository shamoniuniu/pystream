param(
    ...
    [string]$LogPath = "reports/advanced-ha-acceptance.log",
    [string]$RuntimeLogPath = "reports/advanced-ha-runtime.log",
    [string]$EvidencePath = "reports/advanced-ha-evidence.json",
...
if ($ExitCode -ne 0) {
    throw "Advanced HA acceptance failed with exit code $ExitCode"
}
